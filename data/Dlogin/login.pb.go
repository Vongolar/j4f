...
type GuestLoginReq struct {
	...
	Code string `protobuf:"bytes,1,opt,name=code,proto3" json:"code,omitempty"` //设备识别码
}
...
func (x *GuestLoginReq) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
type LoginResp struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` //鉴权码
}
...
var file_login_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x2e, 0x44, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x22, 0x23, 0x0a, 0x0d, 0x47, 0x75,
	0x65, 0x73, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x63,
	...
	0x65, 0x6e, 0x42, 0x13, 0x5a, 0x11, 0x4a, 0x46, 0x46, 0x75, 0x6e, 0x2f, 0x64, 0x61, 0x74, 0x61,
	0x2f, 0x44, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_login_proto_goTypes = []interface{}{
	(*GuestLoginReq)(nil), // 0: data.Dlogin.GuestLoginReq
	(*LoginResp)(nil),     // 1: data.Dlogin.LoginResp
}
